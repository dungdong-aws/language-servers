...
## [0.0.63](https://github.com/dungdong-aws/language-servers/compare/lsp-codewhisperer/v0.0.62...lsp-codewhisperer/v0.0.63) (2025-07-08)
...
* open use input prompt for agentic chat and new prompt should stop current response ([90007d0](https://github.com/dungdong-aws/language-servers/commit/90007d0b05fe8d7415748ea6e539e9d307583970))
...
* add formatChatHistoryMessage to chatDb ([#1110](https://github.com/dungdong-aws/language-servers/issues/1110)) ([353843a](https://github.com/dungdong-aws/language-servers/commit/353843a6467adf63b43cbc9262d7067ebfac2cd3))
...
* add result attribute when emitting amazonq_toolUseSuggested telemetry ([#1107](https://github.com/dungdong-aws/language-servers/issues/1107)) ([d882b18](https://github.com/dungdong-aws/language-servers/commit/d882b188bfdf09d40340d59190839df3acde8e41))
* add result attribute when emitting telemetry event ([#1088](https://github.com/dungdong-aws/language-servers/issues/1088)) ([90007d0](https://github.com/dungdong-aws/language-servers/commit/90007d0b05fe8d7415748ea6e539e9d307583970))
...
* also remove loading if execute failed ([#1096](https://github.com/dungdong-aws/language-servers/issues/1096)) ([08a5d31](https://github.com/dungdong-aws/language-servers/commit/08a5d31de1c79b9e936d7a29da0e467c1d0997af))
...
* **chat-client:** workspace checks for permission cards ([#1089](https://github.com/dungdong-aws/language-servers/issues/1089)) ([bdecb10](https://github.com/dungdong-aws/language-servers/commit/bdecb1095b1a19b5d09f20d7f7762aabcb4090ca))
...
* context transparency list not displayed ([#1095](https://github.com/dungdong-aws/language-servers/issues/1095)) ([9919654](https://github.com/dungdong-aws/language-servers/commit/9919654baf1625eeba3c2023028811b947495809))
...
* execute command should show when no approval required & add more loading ([#1091](https://github.com/dungdong-aws/language-servers/issues/1091)) ([5c48989](https://github.com/dungdong-aws/language-servers/commit/5c48989d18665b84578b9c4bc49a5f3928754619))
...
* falcon context file clicks ([#1094](https://github.com/dungdong-aws/language-servers/issues/1094)) ([d68d148](https://github.com/dungdong-aws/language-servers/commit/d68d1486cb2a563b153c967112a0eada0cc772df))
...
* metric to show tool distribution ([#1090](https://github.com/dungdong-aws/language-servers/issues/1090)) ([bdf3019](https://github.com/dungdong-aws/language-servers/commit/bdf3019c76ab32a73398478358f8bf977505b1db))
...
* request id and error message in error metric ([#1076](https://github.com/dungdong-aws/language-servers/issues/1076)) ([84bccc6](https://github.com/dungdong-aws/language-servers/commit/84bccc6055487df4d4cb30448dabc492f786f6a8))
...
* some chat messages are not added to history ([#1102](https://github.com/dungdong-aws/language-servers/issues/1102)) ([0813bf3](https://github.com/dungdong-aws/language-servers/commit/0813bf31a160e2213ec567ddae63e94690731111))
...
* ux polish for list directory tool messages. ([#1075](https://github.com/dungdong-aws/language-servers/issues/1075)) ([7cefc1f](https://github.com/dungdong-aws/language-servers/commit/7cefc1f5dbcc7518e7b67b0de8f3204f12a74ea4))
* validate tool output content size ([#1111](https://github.com/dungdong-aws/language-servers/issues/1111)) ([e22fd16](https://github.com/dungdong-aws/language-servers/commit/e22fd1605142b1700060e5df20eaa55393dd116b))
